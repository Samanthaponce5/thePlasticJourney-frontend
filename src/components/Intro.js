...
export default class Intro extends React.Component {
	render() {
		...
		return (
            <>
				<div className={`blob blue ${this.props.class}`}>
        		...
        		<div className={`bubbletext bubble-bottom-left ${this.props.class}`} >Hi {this.props.name.charAt(0).toUpperCase()+ this.props.name.slice(1)},
